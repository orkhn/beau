...
export const createAccount = (profile, accounts, userEmail) => {
  ...
  localStorage.setItem("beau-accounts", JSON.stringify(newAccounts));
};
...
export const updateAccount = (
  ...
  localStorage.setItem("beau-accounts", JSON.stringify(accounts));
};
...
export const getLocalAccounts = () =>
  JSON.parse(window.localStorage.getItem("beau-accounts")) || [];
